...
% Bibliography resource (commented out - requires biblatex package setup)
...
% \insertfigure[0.8\textwidth]{figures/system-diagram.png}{System Architecture Overview}{fig:system-overview}

% Example: Side-by-side comparison figures
% \dualfigure[0.45\textwidth]
%     {figures/design-v1.png}{Initial Design Concept}{fig:design-v1}
%     {figures/design-v2.png}{Final Design}{fig:design-v2}
