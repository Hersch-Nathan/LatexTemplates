...
Use the mmath environment for unnumbered aligned equations:
...
\begin{matlab}[caption=Description of Code]
...
\begin{python}[caption=Python Implementation]
...
\begin{terminal}[caption=Command Line Example]
...
% \graphic{path/to/image.pdf}[Figure Title][0.7]

% Side-by-side figures
% \dualfigure{image1.pdf}{image2.pdf}[0.45\textwidth][0.45\textwidth]{Caption 1}{Caption 2}
