% Copied from designreport.tex for renaming as per prompt
\documentclass[final]{../templates/designreport}
...
\begin{tabular}{|c|p{3.5cm}|c|p{3.5cm}|p{3.5cm}|}
\hline
ER Number & Engineering Requirement & MR & Justification & Verification \\
\hline
1 & Touch Response Time: Response time $<$ 100ms; detect 3 pressure levels & 1 & Children require immediate feedback to maintain engagement and associate actions with outcomes & Test response time with oscilloscope; verify pressure detection with calibration weights \\
\hline
2 & Battery Life: Operate $\geq$ 8 hours; battery indicator; low battery warning at 15\% & 3 & Extended play sessions are essential for meaningful learning experiences & Continuous operation test; check indicator and warning at threshold \\
\hline
3 & Safety Standards: Non-toxic materials; enclosed electronics; surface $<$ 40$^\circ$C & 5 & Child safety is paramount in all design decisions & Material certification; enclosure inspection; thermal test during operation \\
\hline
\end{tabular}
\end{table}
