...
\problem{Demonstrate the hwblocks environment for block diagrams.}

\subproblem{Basic block diagram with blox commands.}
...
\subproblem{Block diagram with scaling options.}
