...
% Feature 10: Block Diagrams Environment
\problem{Demonstrate the hwblocks environment for creating control system diagrams.}
...
\bXInput{Input}
\bXCompSum{Sum}{Input}{+}{-}{+}{}
\bXBlocL{Controller}{$K_p + \frac{K_i}{s} + K_d s$}{Sum}
\bXBlocL{Plant}{$\frac{1}{s(s+1)}$}{Controller}
\bXOutput{Output}{Plant}
\bXLink{Input}{Sum}
\bXLink{Sum}{Controller}
\bXLink{Controller}{Plant}
\bXLink{Plant}{Output}
\bXReturn{Plant-Output}{Sum}{}
\end{hwblocks}
...
\bXInput{R}
\bXCompSum[3]{E}{R}{+}{-}{}{}
\bXBlocL[2]{Gc}{$G_c(s)$}{E}
\bXBlocL[2]{Gp}{$G_p(s)$}{Gc}
\bXBlocL[2]{H}{$H(s)$}{Gp}
\bXOutput[2]{Y}{Gp}
\bXLink{R}{E}
\bXLink{E}{Gc}
